...
echo "=== Final-character exact tests ==="
send_osc52 "7 chars, == padding" "1639a41"
echo "  -> clipboard should contain: 1639a41"
send_osc52 "6 chars, no padding" "1639a4"
echo "  -> clipboard should contain: 1639a4"
send_osc52 "5 chars, = padding" "1639a"
echo "  -> clipboard should contain: 1639a"
send_osc52 "1 char, == padding" "A"
echo "  -> clipboard should contain: A"
send_osc52 "2 chars, = padding" "AB"
echo "  -> clipboard should contain: AB"
send_osc52 "3 chars, no padding" "ABC"
echo "  -> clipboard should contain: ABC"
echo ""
